module Util exposing (listAll, listFilledFoldl1Map, listProductMap, listReverseMap, listSumMap)
...
listProductMap : (a -> number) -> List a -> number
listProductMap toNumber list =
    List.foldl (\el acc -> acc * toNumber el) 1 list
